...
3. "Волшебная" модулярная арифметика в narrow phase вроде `(pointIndex + 3 - 3 * fi) % 4`. Я такое ой как люблю, но понимаю, что буду сам это с трудом дешифровывать спустя буквально пару недель.
